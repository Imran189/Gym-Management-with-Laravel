        ...
        <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand" href="index.html">
                ...
                <b class="logo-icon ps-2">
                    ...
                    <!-- Dark Logo icon -->
                    <img src="backend/assets/images/logo-icon.png" alt="homepage" class="light-logo" width="25" />
                </b>
                <!--End Logo icon -->
                <!-- Logo text -->
            ...
            <ul class="navbar-nav float-end">
                ...
                <li class="nav-item dropdown">
                  ...
                  " href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="backend/assets/images/users/1.jpg" alt="user" class="rounded-circle" width="31" />
                    </a>
                        ...
                        <a class="dropdown-item">
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <x-jet-dropdown-link href="{{ route('logout') }}" onclick="event.preventDefault();
                                    ...
                                    <i class="fa fa-power-off me-1 ms-1"></i>{{ __('Log Out') }}
                                </x-jet-dropdown-link>
                            </form>
